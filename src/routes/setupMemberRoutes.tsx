...
const ProjectBuildingTypeEdit = lazy(
  () => import("@/pages/ProjectBuildingTypeEdit")
);
const ProjectBuildingTypeList = lazy(
  () => import("@/pages/ProjectBuildingTypeList")
);
...
const ConnectivityTypeCreate = lazy(
  () => import("@/pages/ConnectivityTypeCreate")
);
...
const ConstructionStatusEdit = lazy(
  () => import("@/pages/ConstructionStatusEdit")
);
const ConstructionStatusList = lazy(
  () => import("@/pages/ConstructionStatusList")
);
const ConstructionUpdatesCreate = lazy(
  () => import("@/pages/ConstructionUpdatesCreate")
);
const ConstructionUpdatesEdit = lazy(
  () => import("@/pages/ConstructionUpdatesEdit")
);
const ConstructionUpdatesList = lazy(
  () => import("@/pages/ConstructionUpdatesList")
);
...
const ReferralProgramCreate = lazy(
  () => import("@/pages/ReferralProgramCreate")
);
...
const SiteVisitSlotConfigList = lazy(
  () => import("@/pages/SiteVisitSlotConfigList")
);
...
const ProjectConfigurationList = lazy(
  () => import("@/pages/ProjectConfiguraionList")
);
...
const BMSDocumentsFlatRelated = lazy(
  () => import("@/pages/BMSDocumentsFlatRelated")
);
...
const CMSClubMembersDetails = lazy(
  () => import("@/pages/CMSClubMembersDetails")
);
...
const CMSPaymentPlanSetupAdd = lazy(
  () => import("@/pages/CMSPaymentPlanSetupAdd")
);
const CMSPaymentPlanSetupDetails = lazy(
  () => import("@/pages/CMSPaymentPlanSetupDetails")
);

// Campaigns Pages
const CampaignsReferrals = lazy(() => import("@/pages/CampaignsReferrals"));
const CampaignsReferralSetup = lazy(
  () => import("@/pages/CampaignsReferralSetup")
);
const CampaignsOtherProject = lazy(
  () => import("@/pages/CampaignsOtherProject")
);
...
const CampaignsReferralSetupCreate = lazy(
  () => import("@/pages/CampaignsReferralSetupCreate")
);
const CampaignsReferralSetupEdit = lazy(
  () => import("@/pages/CampaignsReferralSetupEdit")
);
const CampaignsReferralDetail = lazy(
  () => import("@/pages/CampaignsReferralDetail")
);
...
const AccountingOpeningBalances = lazy(
  () => import("@/pages/AccountingOpeningBalances")
);
...
const AccountingCustomSettings = lazy(
  () => import("@/pages/AccountingCustomSettings")
);
const AccountingBalanceSheet = lazy(
  () => import("@/pages/AccountingBalanceSheet")
);
...
const AccountingGSTReceivable = lazy(
  () => import("@/pages/AccountingGSTReceivable")
);
...
const AddFitoutChecklistPage = lazy(
  () => import("@/pages/AddFitoutChecklistPage")
);
const EditFitoutChecklistPage = lazy(
  () => import("@/pages/EditFitoutChecklistPage")
);
const FitoutChecklistDetailsPage = lazy(
  () => import("@/pages/FitoutChecklistDetailsPage")
);
const CategorySubcategoryPage = lazy(
  () => import("@/components/fitout-requests/CategorySubcategoryDialog")
);
const FitoutDeviations = lazy(() => import("@/pages/FitoutDeviations"));
const FitoutDeviationDetails = lazy(
  () => import("@/pages/FitoutDeviationDetails")
);
...
const SmartSecureVisitorOut = lazy(
  () => import("@/pages/SmartSecureVisitorOut")
);
...
const SmartSecureStaffsHistory = lazy(
  () => import("@/pages/SmartSecureStaffsHistory")
);
...
const SmartSecureReportsVisitors = lazy(
  () => import("@/pages/SmartSecureReportsVisitors")
);
const SmartSecureReportsStaffs = lazy(
  () => import("@/pages/SmartSecureReportsStaffs")
);
const SmartSecureReportsMemberVehicles = lazy(
  () => import("@/pages/SmartSecureReportsMemberVehicles")
);
const SmartSecureReportsGuestVehicles = lazy(
  () => import("@/pages/SmartSecureReportsGuestVehicles")
);
...
const SmartSecureSetupGeneral = lazy(
  () => import("@/pages/SmartSecureSetupGeneral")
);
const SmartSecureSetupVisitorParking = lazy(
  () => import("@/pages/SmartSecureSetupVisitorParking")
);
...
const IncidentsDesignInputs = lazy(
  () => import("@/pages/IncidentsDesignInputs")
);
...
export const setupMemberRoutes = (
  <>
    ...
    <Route
      ...
      Component={withSuspense(AmenitiesList)}
    />
    <Route
      path="/settings/amenities-edit/:id"
      Component={withSuspense(EditAmenities)}
    />

    {/* Connectivity Type Routes */}
    <Route
      path="/settings/connectivity-type-list"
      Component={withSuspense(ConnectivityTypeList)}
    />
    <Route
      path="/settings/connectivity-type-create"
      Component={withSuspense(ConnectivityTypeCreate)}
    />
    <Route
      path="/settings/connectivity-type-edit/:id"
      Component={withSuspense(ConnectivityTypeEdit)}
    />
    ...
    {/* Bank Details Routes */}
    <Route
      path="/settings/bank-details-create"
      Component={withSuspense(BankDetailsCreate)}
    />
    <Route
      path="/settings/bank-details-edit/:id"
      Component={withSuspense(BankDetailsEdit)}
    />
    <Route
    ...
    <Route
      ...
      Component={withSuspense(BanksCreate)}
    />

    {/* Banner Routes */}
    <Route path="/maintenance/banner-add" Component={withSuspense(BannerAdd)} />
    <Route
      path="/maintenance/banner-edit/:id"
      Component={withSuspense(BannerEdit)}
    />
    <Route
      path="/maintenance/banner-list"
      Component={withSuspense(BannerList)}
    />

    {/* Category Types Routes */}
    <Route
      path="/settings/category-types"
      Component={withSuspense(CategoryTypes)}
    />
    <Route
      path="/settings/category-types-edit/:id"
      Component={withSuspense(CategoryTypesEdit)}
    />
    <Route
      path="/settings/category-types-list"
      Component={withSuspense(CategoryTypesList)}
    />

    {/* Common Files Routes */}
    <Route
      path="/settings/common-files"
      Component={withSuspense(CommonFiles)}
    />

    {/* Company Routes */}
    <Route
      path="/maintenance/company-create"
      Component={withSuspense(CompanyCreate)}
    />
    <Route
      path="/maintenance/company-edit/:id"
      Component={withSuspense(CompanyEdit)}
    />
    <Route
      path="/maintenance/company-list"
      Component={withSuspense(CompanyList)}
    />

    {/* Construction Status Routes */}
    <Route
      path="/settings/construction-status"
      Component={withSuspense(ConstructionStatus)}
    />
    <Route
      path="/settings/construction-status-edit/:id"
      Component={withSuspense(ConstructionStatusEdit)}
    />
    <Route
      path="/settings/construction-status-list"
      Component={withSuspense(ConstructionStatusList)}
    />

    {/* Construction Updates Routes */}
    <Route
      path="/settings/construction-updates-create"
      Component={withSuspense(ConstructionUpdatesCreate)}
    />
    <Route
      path="/settings/construction-updates-edit/:id"
      Component={withSuspense(ConstructionUpdatesEdit)}
    />
    <Route
      path="/settings/construction-updates-list"
      Component={withSuspense(ConstructionUpdatesList)}
    />

    {/* Rule Engine Routes */}
    <Route
      path="/loyalty/create-rule-engine"
      Component={withSuspense(CreateRuleEngine)}
    />

    {/* Enquiry Routes */}
    <Route
      path="/settings/enquiry-list"
      Component={withSuspense(EnquiryList)}
    />
    ...
    <Route
      ...
      Component={withSuspense(NoticeboardList)}
    />
    <Route
      path="/maintenance/noticeboard-create"
      Component={withSuspense(BroadcastCreate)}
    />
    <Route
      path="/maintenance/noticeboard-edit/:id"
      Component={withSuspense(NoticeboardEdit)}
    />
    <Route
      path="/maintenance/noticeboard-details/:id"
      Component={withSuspense(BroadcastDetails)}
    />

    {/* FAQ Routes */}
    <Route
      path="/settings/faq-category-form"
      Component={withSuspense(FaqCategoryForm)}
    />
    <Route
      path="/settings/faq-category-form/:faqId"
      Component={withSuspense(FaqCategoryForm)}
    />
    <Route
      path="/settings/faq-category-list"
      Component={withSuspense(FaqCategoryList)}
    />
    ...
    <Route
      path="/settings/faq-subcategory"
      Component={withSuspense(FaqSubCategory)}
    />
    <Route
      path="/settings/faq-subcategory/:faqSubId"
      Component={withSuspense(FaqSubCategory)}
    />
    <Route
      path="/settings/faq-subcategory/:faqSubId/edit"
      Component={withSuspense(FaqSubCategory)}
    />
    <Route
      path="/settings/faq-subcategory-list"
      Component={withSuspense(FaqSubCategoryList)}
    />

    {/* Gallery Routes */}
    <Route path="/setup-member/gallery" Component={withSuspense(Gallery)} />
    <Route
      path="/setup-member/gallery-details/:id"
      Component={withSuspense(GalleryDetails)}
    />
    <Route
      path="/setup-member/gallery-list"
      Component={withSuspense(GalleryList)}
    />
    <Route
      path="/setup-member/new-gallery"
      Component={withSuspense(NewGallery)}
    />

    {/* Home Loan Routes */}
    <Route
      path="/settings/home-loan-create"
      Component={withSuspense(HomeLoanCreate)}
    />
    <Route
      path="/settings/home-loan-edit/:id"
      Component={withSuspense(HomeLoanEdit)}
    />
    <Route
      path="/settings/home-loan-list"
      Component={withSuspense(HomeLoanList)}
    />

    {/* Image Config Routes */}
    <Route
      path="/settings/image-config-create"
      Component={withSuspense(ImageConfigCreate)}
    />
    <Route
      path="/settings/image-config-edit/:id"
      Component={withSuspense(ImageConfigEdit)}
    />
    <Route
      path="/settings/image-config-list"
      Component={withSuspense(ImageConfigList)}
    />

    {/* Loan Manager Routes */}
    <Route
      path="/settings/loan-manager-add"
      Component={withSuspense(LoanManagerAdd)}
    />
    <Route
      path="/settings/loan-manager-edit/:id"
      Component={withSuspense(LoanManagerEdit)}
    />
    <Route
      path="/settings/loan-manager-list"
      Component={withSuspense(LoanManagerList)}
    />
    ...
    <Route
      path="/settings/lock-function-create"
      Component={withSuspense(LockFunctionCreate)}
    />
    <Route
      path="/settings/lock-function-list"
      Component={withSuspense(LockFunctionList)}
    />
    <Route
      path="/settings/lock-function-edit/:id"
      element={<LockFunctionEdit />}
    />

    {/* Lock Role Routes */}
    <Route
      path="/settings/lock-role-create"
      Component={withSuspense(LockRoleCreate)}
    />
    <Route
      path="/settings/lock-role-list"
      Component={withSuspense(LockRoleList)}
    />

    {/* Loyalty Manager Routes */}
    <Route
      path="/loyalty/loyalty-managers-create"
      Component={withSuspense(LoyaltyManagersCreate)}
    />
    <Route
      path="/loyalty/loyalty-managers-edit/:id"
      Component={withSuspense(LoyaltyManagersEdit)}
    />
    <Route
      path="/loyalty/loyalty-managers-list"
      Component={withSuspense(LoyaltyManagersList)}
    />

    {/* Organization Routes */}
    <Route
      path="/maintenance/organization-create"
      Component={withSuspense(OrganizationCreate)}
    />
    <Route
      path="/maintenance/organization-list"
      Component={withSuspense(OrganizationList)}
    />
    <Route
      path="/maintenance/organization-update/:id"
      Component={withSuspense(OrganizationUpdate)}
    />

    {/* Project Details Routes */}
    <Route
      path="/maintenance/project-details-create"
      Component={withSuspense(ProjectDetailsCreate)}
    />
    <Route
      path="/maintenance/project-details-edit/:id"
      Component={withSuspense(ProjectDetailsEdit)}
    />
    <Route
      path="/maintenance/project-details-view/:id"
      Component={withSuspense(ProjectDetails)}
    />
    <Route
      path="/maintenance/project-details-list"
      Component={withSuspense(ProjectDetailsList)}
    />

    <Route
      path="/settings/project-building-type"
      Component={withSuspense(ProjectBuildingType)}
    />
    <Route
      path="/settings/project-building-type-edit/:id"
      Component={withSuspense(ProjectBuildingTypeEdit)}
    />
    <Route
      path="/settings/project-building-type-list"
      Component={withSuspense(ProjectBuildingTypeList)}
    />

    <Route
      path="/settings/project-details-create"
      Component={withSuspense(ProjectDetailsCreate)}
    />
    <Route
      path="/settings/project-details-edit/:id"
      Component={withSuspense(ProjectDetailsEdit)}
    />
    <Route
      path="/settings/project-details-view/:id"
      Component={withSuspense(ProjectDetails)}
    />
    <Route
      path="/settings/project-details-list"
      Component={withSuspense(ProjectDetailsList)}
    />
    ...
    <Route
      ...
      Component={withSuspense(PropertyType)}
    />
    <Route
      path="/settings/property-type-edit/:id"
      Component={withSuspense(PropertyTypeEdit)}
    />
    <Route
      path="/settings/property-type-list"
      Component={withSuspense(PropertyTypeList)}
    />

    {/* Referral Routes */}
    <Route
      path="/loyalty/referral-create"
      Component={withSuspense(ReferralCreate)}
    />
    <Route
      path="/loyalty/referral-edit/:id"
      Component={withSuspense(ReferralEdit)}
    />
    <Route
      path="/loyalty/referral-list"
      Component={withSuspense(ReferralList)}
    />

    {/* Referral Program Routes */}
    <Route
      path="/maintenance/referral-program-create"
      Component={withSuspense(ReferralProgramCreate)}
    />
    <Route
      path="/maintenance/referral-program-edit/:id"
      Component={withSuspense(ReferralProgramEdit)}
    />
    <Route
      path="/maintenance/referral-program-list"
      Component={withSuspense(ReferralProgramList)}
    />

    {/* Service Category Routes */}
    <Route
      path="/settings/service-category"
      Component={withSuspense(ServiceCategory)}
    />
    <Route
      path="/settings/service-category/:serviceId"
      Component={withSuspense(ServiceCategory)}
    />
    <Route
      path="/settings/service-category-list"
      Component={withSuspense(ServiceCategoryList)}
    />

    {/* Site Routes */}
    <Route
      path="/maintenance/site-create"
      Component={withSuspense(SiteCreate)}
    />
    <Route
      path="/maintenance/site-edit/:id"
      Component={withSuspense(SiteEdit)}
    />
    <Route path="/maintenance/site-list" Component={withSuspense(SiteList)} />

    {/* Site Visit Routes */}
    <Route
      path="/settings/site-visit-create"
      Component={withSuspense(SiteVisitCreate)}
    />
    <Route
      path="/settings/site-visit-edit/:id"
      Component={withSuspense(SiteVisitEdit)}
    />
    <Route
      path="/settings/site-visit-list"
      Component={withSuspense(SiteVisitList)}
    />

    {/* Site Visit Slot Config Routes */}
    <Route
      path="/settings/site-visit-slot-config"
      Component={withSuspense(SiteVisitSlotConfig)}
    />
    <Route
      path="/settings/site-visit-slot-config-list"
      Component={withSuspense(SiteVisitSlotConfigList)}
    />

    {/* SMTP Settings Routes */}
    <Route
      path="/settings/smtp-settings-edit/:id"
      Component={withSuspense(SmtpSettingsEdit)}
    />
    <Route
      path="/settings/smtp-settings-list"
      Component={withSuspense(SmtpSettingsList)}
    />

    {/* Specification Routes */}
    <Route
      path="/maintenance/specification"
      Component={withSuspense(Specification)}
    />
    <Route
      path="/maintenance/specification-list"
      Component={withSuspense(SpecificationList)}
    />
    <Route
      path="/maintenance/specification-update/:id"
      Component={withSuspense(SpecificationUpdate)}
    />

    {/* Support Service Routes */}
    <Route
      path="/settings/support-service-list"
      Component={withSuspense(SupportServiceList)}
    />
    ...
    <Route
      path="/settings/tds-tutorials-create"
      Component={withSuspense(TdsTutorialsCreate)}
    />
    <Route
      path="/settings/tds-tutorials-edit/:id"
      Component={withSuspense(TdsTutorialsEdit)}
    />
    <Route
      path="/settings/tds-tutorials-list"
      Component={withSuspense(TdsTutorialsList)}
    />

    {/* Testimonial Routes */}
    <Route
      path="/maintenance/testimonials"
      Component={withSuspense(Testimonials)}
    />
    <Route
      path="/maintenance/testimonial-edit/:id"
      Component={withSuspense(TestimonialEdit)}
    />
    <Route
      path="/maintenance/testimonial-list"
      Component={withSuspense(TestimonialList)}
    />
    ...
    <Route
      ...
      Component={withSuspense(UserGroupsCreate)}
    />
    <Route
      path="/settings/user-groups-edit/:id"
      Component={withSuspense(UserGroupsEdit)}
    />
    <Route
      path="/settings/user-groups-list"
      Component={withSuspense(UserGroupsList)}
    />
    <Route
      path="/settings/groups-list"
      Component={withSuspense(FMGroupDashboard)}
    />

    {/* Press Releases Routes */}
    <Route
      path="/maintenance/press-releases-create"
      Component={withSuspense(PressReleasesCreate)}
    />
    <Route
      path="/maintenance/press-releases-edit/:id"
      Component={withSuspense(PressReleasesEdit)}
    />
    <Route
      path="/maintenance/press-releases-list"
      Component={withSuspense(PressReleasesList)}
    />
    ...
    <Route
      ...
      Component={withSuspense(LockPaymentsList)}
    />
    <Route
      path="/loyalty/home-loan-requests-list"
      Component={withSuspense(HomeLoanRequestsList)}
    />
    <Route
      path="/loyalty/demand-notes-list"
      Component={withSuspense(DemandNotesList)}
    />
    ...
    <Route
      ...
      Component={withSuspense(ProjectConfiguration)}
    />
    <Route
      path="/settings/project-configuration-list"
      Component={withSuspense(ProjectConfigurationList)}
    />
    <Route
      path="/settings/project-configuration-edit/:id"
      element={<ProjectConfigEdit />}
    />

    {/* Plus Services Routes */}
    <Route
      path="/settings/plus-services-list"
      Component={withSuspense(PlusServicesList)}
    />
    <Route
      path="/settings/plus-services-create"
      Component={withSuspense(PlusServicesCreate)}
    />
    ...
    <Route
      ...
      Component={withSuspense(BMSDocumentsFlatRelated)}
    />
    <Route
    ...
    <Route
      ...
      Component={withSuspense(BMSHelpdeskReport)}
    />
    <Route
      path="/bms/invoice-report"
      Component={withSuspense(BMSInvoiceReport)}
    />
    ...
    <Route
      ...
      Component={withSuspense(CampaignsReferrals)}
    />
    <Route
      path="/campaigns/referral-setup"
      Component={withSuspense(CampaignsReferralSetup)}
    />
    <Route
      path="/campaigns/other-project"
      Component={withSuspense(CampaignsOtherProject)}
    />
    <Route
    ...
    />
    <Route
      path="/campaigns/referral-setup/create"
      Component={withSuspense(CampaignsReferralSetupCreate)}
    />
    <Route
      path="/campaigns/referral-setup/edit/:id"
      Component={withSuspense(CampaignsReferralSetupEdit)}
    />
    <Route
      path="/campaigns/referrals/detail/:id"
      Component={withSuspense(CampaignsReferralDetail)}
    />
    ...
    <Route
      ...
      Component={withSuspense(OSRManageBookings)}
    />

    {/* Accounting Routes */}
    <Route
      path="/accounting/dashboard"
      Component={withSuspense(AccountingDashboard)}
    />
    <Route
    ...
    <Route
      ...
      Component={withSuspense(AccountingOpeningBalances)}
    />
    <Route
      path="/accounting/tax-setup"
      Component={withSuspense(AccountingTaxSetup)}
    />
    <Route
      path="/accounting/cost-center"
      Component={withSuspense(AccountingCostCenter)}
    />
    <Route
    ...
    <Route
      ...
      Component={withSuspense(AccountingChargeCalculations)}
    />
    <Route
    ...
    <Route
      ...
      Component={withSuspense(AccountingGSTPayable)}
    />
    <Route
      path="/accounting/gst-receivable"
      Component={withSuspense(AccountingGSTReceivable)}
    />
    <Route
      path="/accounting/tax-summary"
      Component={withSuspense(AccountingTaxSummary)}
    />
    <Route
    ...
    <Route
      path="/fitout/requests/add"
      Component={withSuspense(FitoutRequestAdd)}
    />
    <Route
      path="/fitout/requests/details/:id"
      Component={withSuspense(FitoutRequestDetails)}
    />
    <Route
      path="/fitout/requests/edit/:id"
      Component={withSuspense(FitoutRequestEdit)}
    />
    <Route
      path="/fitout/checklists"
      Component={withSuspense(FitoutChecklists)}
    />
    <Route
      path="/fitout/checklists/add"
      Component={withSuspense(AddFitoutChecklistPage)}
    />
    <Route
      path="/fitout/checklists/edit/:id"
      Component={withSuspense(EditFitoutChecklistPage)}
    />
    <Route
      path="/fitout/checklists/details/:id"
      Component={withSuspense(FitoutChecklistDetailsPage)}
    />
    <Route
      path="/fitout/categories-subcategories"
      Component={withSuspense(CategorySubcategoryPage)}
    />
    <Route
      path="/fitout/deviations"
      Component={withSuspense(FitoutDeviations)}
    />
    <Route
      path="/fitout/deviations"
      Component={withSuspense(FitoutDeviations)}
    />
    <Route
      path="/fitout/deviation-details/:flat_id"
      Component={withSuspense(FitoutDeviationDetails)}
    />
    <Route
      path="/fitout/deviation-detail/:deviation_id"
      Component={withSuspense(ViolationDetail)}
    />
    ...
    <Route
      ...
      Component={withSuspense(SmartSecureVisitorOut)}
    />
    <Route
    ...
    <Route
      ...
      Component={withSuspense(SmartSecureStaffsOut)}
    />
    <Route
    ...
    <Route
      ...
      Component={withSuspense(SmartSecureVehiclesOut)}
    />
    <Route
      path="/smartsecure/vehicles/history"
      Component={withSuspense(SmartSecureVehiclesHistory)}
    />
    <Route
      path="/smartsecure/reports/visitors"
      Component={withSuspense(SmartSecureReportsVisitors)}
    />
    <Route
      path="/smartsecure/reports/staffs"
      Component={withSuspense(SmartSecureReportsStaffs)}
    />
    <Route
      path="/smartsecure/reports/member-vehicles"
      Component={withSuspense(SmartSecureReportsMemberVehicles)}
    />
    <Route
      path="/smartsecure/reports/guest-vehicles"
      Component={withSuspense(SmartSecureReportsGuestVehicles)}
    />
    <Route
      path="/smartsecure/reports/patrolling"
    ...
    <Route
      ...
      Component={withSuspense(SmartSecureSetupVisitorParking)}
    />
    <Route
      path="/smartsecure/setup/support-staff"
      Component={withSuspense(SmartSecureSetupSupportStaff)}
    />
    ...
    <Route
      ...
      Component={withSuspense(IncidentsIncidents)}
    />
    <Route
      path="/incidents/design-inputs"
      Component={withSuspense(IncidentsDesignInputs)}
    />
    ...
    <Route
      ...
      Component={withSuspense(AppointmentzSiteScheduling)}
    />
    <Route
    ...
    <Route
      ...
      Component={withSuspense(TemplateList)}
    />
    <Route
      path="/settings/template/list"
      Component={withSuspense(TemplateList)}
    ...
    <Route
      ...
      Component={withSuspense(AddTemplatePage)}
    />
    <Route
