...
export const DEFAULT_ESCALATION_GRID_LAYOUT: GridLayout.Layout[] = [
  { i: 'kpi-open-escalation', x: 0, y: 0, w: 3, h: 3, minW: 2, minH: 3, maxH: 3 },
  { i: 'kpi-close-escalation', x: 3, y: 0, w: 3, h: 3, minW: 2, minH: 3, maxH: 3 },
  { i: 'kpi-average-escalation', x: 6, y: 0, w: 3, h: 3, minW: 2, minH: 3, maxH: 3 },
  { i: 'kpi-total-escalation', x: 9, y: 0, w: 3, h: 3, minW: 2, minH: 3, maxH: 3 },
