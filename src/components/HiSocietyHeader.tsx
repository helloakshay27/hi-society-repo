...
export const HiSocietyHeader: React.FC = () => {
  ...
  return (
    <header className="h-16 bg-white border-b border-[#D5DbDB] fixed top-0 left-0 right-0 z-20 w-full shadow-sm">
      <div className="flex items-center justify-between h-full px-6">
        ...
        <div className="flex items-center gap-3 flex-shrink-0">
          ...
          <DropdownMenu open={isProfileOpen} onOpenChange={setIsProfileOpen}>
            ...
            <DropdownMenuContent align="end" className="w-72 bg-white border border-[#D5DbDB] shadow-lg p-0">
              {/* User Info Header */}
