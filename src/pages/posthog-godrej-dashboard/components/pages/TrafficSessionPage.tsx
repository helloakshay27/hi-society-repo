...
/** Godrej Living — Traffic & Session tab, matching the wireframe's pgTraffic section, wired to live Runwal-family PostHog APIs. */
export const TrafficSessionPage: React.FC<TrafficSessionPageProps> = ({ filters, showPrev, benchmarks, onBenchmarkChange, sitesSettled = true }) => {
  ...
  return (
    <section className="page on" id="pgTraffic">
      ...
      <QuestionBox
        questions={[
          'How many residents and admins are actively using the app, and how frequently?',
          'Which societies generate the highest traffic, and are residents staying active day over day?',
        ]}
      />
      ...
      <div className="tiles" style={{ gridTemplateColumns: 'repeat(3, 1fr)' }}>
        <KpiTile
          ...
          sub="unique residents/admins this period"
      ...
      <div className="grid2">
        <Card
          ...
          purpose="Visitors, screen views, and sessions over time, across all projects, with the previous period overlaid for comparison."
        >
          {isUsageError ? (
              ...
              {usageTab === 'visitors' && (
                <>
                  ...
                  <div className="legend">
                    <span>
                      <i style={{ background: 'var(--chart-blue)' }}></i> Visitors
                    </span>
