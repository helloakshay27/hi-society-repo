...
/** Godrej Living — Workflow Usage tab, matching the wireframe's pgFlows section, wired to live Runwal-family PostHog APIs. */
  ...
  return (
    <section className="page on" id="pgFlows">
      <div className="section-head">
        ...
        <span className="sd">
          Resident completion of key community-service workflows per module, all-modules comparison, and where residents navigate &amp; exit.
        </span>
      </div>
