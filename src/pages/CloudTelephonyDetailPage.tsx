...
import { ArrowLeft, Star, Download, ThumbsUp, ThumbsDown, User, Building, Mail, Phone, Globe } from 'lucide-react';
  ...
  const screenshots = [
    {
      ...
      description: 'Comprehensive call management dashboard'
    },
    {
      id: 2,
      title: 'VoIP Configuration',
      image: 'https://images.unsplash.com/photo-1544197150-b99a580bb7a8?w=800&h=600&fit=crop&crop=center',
      description: 'Easy VoIP setup and configuration interface'
    },
    {
      id: 3,
      title: 'Analytics & Reports',
      image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&h=600&fit=crop&crop=center',
      description: 'Detailed call analytics and performance reports'
    },
    {
      id: 4,
      title: 'Team Management',
      image: 'https://images.unsplash.com/photo-1552664730-d307ca884978?w=800&h=600&fit=crop&crop=center',
      description: 'Team collaboration and call routing features'
    }
  ];
  ...
  const reviews = [
    {
      ...
      rating: 5,
      date: 'March 12, 2024',
      title: 'Outstanding call quality and features',
      comment: 'The voice quality is crystal clear and the feature set is comprehensive. Perfect for our growing business needs.',
      helpful: 31,
      avatar: 'AT'
    },
    {
      ...
      comment: 'Affordable solution with enterprise-grade features. The setup was straightforward and support is responsive.',
      helpful: 26,
      avatar: 'MG'
    },
    {
      ...
      comment: 'Integrates perfectly with our CRM system. The call analytics help us improve our customer service significantly.',
      helpful: 19,
      avatar: 'DP'
    },
    {
      ...
      title: 'Reliable cloud telephony',
      comment: 'Very reliable service with minimal downtime. The mobile app works great for remote team members.',
      helpful: 23,
      avatar: 'JL'
    }
  ];
      ...
      <div className="lg:col-span-2 space-y-6">
        <div>
          ...
          <p className="text-gray-600 mb-4">
            Transform your business communications with our advanced Cloud Telephony solution. Designed for modern 
            businesses, this comprehensive platform provides enterprise-grade voice services, call management, and 
            analytics through the cloud, enabling seamless communication from anywhere.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-600">
            <li>• Crystal-clear HD voice quality with advanced noise cancellation</li>
            <li>• Intelligent call routing and automated attendant features</li>
            <li>• Real-time analytics and comprehensive call reporting</li>
            <li>• Seamless CRM integration and click-to-call functionality</li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <span className="bg-[#C72030] text-white px-3 py-1 rounded text-sm">VoIP</span>
  ...
  const renderScreenshots = () => (
    <div className="space-y-6">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">Explore the key features and interface of Cloud Telephony</p>
      </div>
                ...
                <div key={rating} className="flex items-center space-x-2 text-sm">
                  ...
                  <div className="w-20 bg-gray-200 rounded-full h-2">
                    <div 
                      ...
                      style={{ width: rating === 5 ? '55%' : rating === 4 ? '35%' : rating === 3 ? '10%' : '0%' }}
                    ></div>
                  </div>
                  <span className="text-gray-500 w-8">{rating === 5 ? '5' : rating === 4 ? '3' : rating === 3 ? '1' : '0'}</span>
                </div>
              ))}
            </div>
          </div>
    ...
    <div className="space-y-6">
      <div className="bg-white p-6 rounded-lg shadow-sm border">
        <div className="flex items-start space-x-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-600 mb-4">
              FM Solutions is a leading provider of enterprise communication solutions specializing in cloud-based 
              telephony and VoIP services. With over 10 years of experience, we help businesses modernize their 
              communication infrastructure through innovative cloud technologies.
            </p>
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            { name: 'Video Conferencing Pro', rating: 4.6, installs: '1.5K+' },
            { name: 'Call Center Manager', rating: 4.4, installs: '890+' },
            { name: 'VoIP Analytics Suite', rating: 4.7, installs: '1.2K+' }
          ].map((app, index) => (
