...
export const VendorCreditsDetails = () => {
  const { id } = useParams();
  ...
  const handleClone = () => {
    ...
    navigate("/accounting/bills/create");
  };
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Badge
              className={`${getStatusColor(salesOrder.orderDetails.status)} border`}
            >
        ...
        >
          <style>{`
                        .vendor-credits-tabs button[data-state="active"] {
          ...
          >
            <TabsList
              className="vendor-credits-tabs w-full flex flex-nowrap rounded-t-lg p-0 overflow-x-auto mb-4"
              style={{
                gap: "0",
                padding: "0",
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div>
                      ...
                      <p className="text-base font-semibold mt-1">
                        {salesOrder.orderDetails.orderNumber}
                      </p>
                    </div>
                    <div>
                      <p className="text-sm font-medium text-muted-foreground">
                      ...
                      <p className="text-base font-semibold mt-1">
                        {salesOrder.orderDetails.referenceNumber}
                      </p>
                    </div>
                    <div>
                      <p className="text-sm font-medium text-muted-foreground">
                      ...
                      <p className="text-base font-semibold mt-1">
                        {new Date(
                          salesOrder.orderDetails.orderDate
                        ).toLocaleDateString()}
                      </p>
                    </div>
                    <div>
                      ...
                      <p className="text-base font-semibold mt-1">
                        {new Date(
                          salesOrder.orderDetails.expectedDeliveryDate
                        ).toLocaleDateString()}
                      </p>
                    </div>
                    <div>
                      ...
                      <p className="text-base font-semibold mt-1">
                        {salesOrder.orderDetails.paymentTerms}
                      </p>
                    </div>
                    <div>
                      <p className="text-sm font-medium text-muted-foreground">
                      ...
                      <p className="text-base font-semibold mt-1">
                        {salesOrder.orderDetails.deliveryMethod}
                      </p>
                    </div>
                    <div>
                      <p className="text-sm font-medium text-muted-foreground">
                      ...
                      <p className="text-base font-semibold mt-1">
                        {salesOrder.orderDetails.salesperson}
                      </p>
                    </div>
                  </div>
                </CardContent>
                    ...
                    <div className="w-full max-w-md space-y-3 bg-muted/30 p-4 rounded-lg">
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="font-semibold">
                          ₹{salesOrder.pricing.subTotal.toFixed(2)}
                        </span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span className="text-muted-foreground">Discount</span>
                        <span className="font-semibold text-red-600">
                          -₹{salesOrder.pricing.discount.toFixed(2)}
                        </span>
                      </div>
                      <div className="flex justify-between text-sm">
                        <span className="text-muted-foreground">Tax</span>
                        <span className="font-semibold">
                          ₹{salesOrder.pricing.taxAmount.toFixed(2)}
                        </span>
                      </div>
                      {salesOrder.pricing.adjustment !== 0 && (
                        <div className="flex justify-between text-sm">
                          ...
                          <span className="font-semibold">
                            ₹{salesOrder.pricing.adjustment.toFixed(2)}
                          </span>
                        </div>
                      )}
                      <div className="border-t pt-3 flex justify-between text-lg">
                        ...
                        <span className="font-bold text-primary">
                          ₹{salesOrder.pricing.total.toFixed(2)}
                        </span>
                      </div>
                    </div>
                  </div>
                  ...
                  <CardContent>
                    <div className="space-y-2">
                      {salesOrder.attachments.map(
                        (file: BillAttachment, index: number) => (
                          <div
                            key={index}
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Card>
                  ...
                  <CardContent>
                    <p className="text-sm text-muted-foreground">
                      {salesOrder.vendor.billingAddress}
                    </p>
                  </CardContent>
                </Card>
                ...
                <Card>
                  ...
                  <CardContent>
                    <p className="text-sm text-muted-foreground">
                      {salesOrder.vendor.shippingAddress}
                    </p>
                  </CardContent>
                </Card>
              </div>
...
export default VendorCreditsDetails;
