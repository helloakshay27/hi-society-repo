...
export const EditBookingSetupClubPage = () => {
    ...
    const fetchFacilityDetails = async () => {
        try {
            ...
            const data = response.data.facility_setup;
            ...
            const transformedChargeSetup = {
                ...
                minimumPersonAllowed: data.min_people || "1",
                maximumPersonAllowed: data.max_people || "1",
                refundableDeposit: data.deposit || "0.0",
            };
            ...
            setFormData({
                ...
                addSubFacility: data.sub_facility_enabled,
                ...
                bookingAllowedBefore: {
                    day: data.bb_dhm.d || "",
                    hour: data.bb_dhm.h || "",
                    minute: data.bb_dhm.m || "",
                },
                advanceBooking: {
                    day: data.ab_dhm.d || "",
                    hour: data.ab_dhm.h || "",
                    minute: data.ab_dhm.m || "",
                },
                canCancelBefore: {
                    day: data.cb_dhm.d || "",
                    hour: data.cb_dhm.h || "",
            ...
            // Fetch slots for block days that have dates (so slots can be displayed)
