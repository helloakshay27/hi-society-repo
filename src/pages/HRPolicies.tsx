...
const policyItems: PolicyItem[] = [
  {
    ...
    files: [
      { id: "p1-1", title: "Leave Policy" },
      { id: "p1-2", title: "Code of Conduct" },
    ],
  },
  {
    id: "2",
    ...
    description:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt",
    files: [
      { id: "p2-1", title: "Performance Bonus" },
      { id: "p2-2", title: "Awards Criteria" },
    ],
  },
  {
    id: "3",
    ...
    description:
      "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt",
    files: [{ id: "p3-1", title: "Employment Terms" }],
  },
  {
    id: "4",
...
const HRPolicies: React.FC = () => {
  ...
  const handleFileClick = (file: PolicyFile) => {
    ...
    <div className="min-h-screen bg-[#FDFBF7] p-6 lg:p-10 font-sans">
      ...
      <div className="relative mb-8">
        ...
        <div className="text-center w-full max-w-5xl mx-auto pt-2">
          <h1 className="text-xl font-bold text-gray-900 mb-4">Policy Hub</h1>
      ...
      <div className="max-w-2xl mx-auto mb-10">
        <div className="relative">
          ...
          <input
            type="text"
            placeholder="Search Article, Policy"
