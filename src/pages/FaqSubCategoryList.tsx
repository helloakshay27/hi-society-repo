  ...
  useEffect(() => {
    const fetchSubCategories = async () => {
      ...
      try {
        ...
        } else if (response.data?.faq_sub_categories && Array.isArray(response.data.faq_sub_categories)) {
      ...
      <div className="p-6 max-w-full h-[calc(100vh-50px)] overflow-y-auto">
        ...
        <div className="mb-6">
          <div className="flex items-center space-x-2 text-sm text-gray-600 mb-2">
            ...
            <ChevronRight className="w-4 h-4" />
            <span className="text-[#C72030] font-medium">FAQ Sub Category</span>
          </div>
          <h1 className="text-2xl font-bold text-gray-900">FAQ SUB CATEGORIES</h1>
        </div>
        ...
        <div className="flex justify-end items-center gap-3 mb-4">
          ...
          {faqSubCategoryPermissions.create === "true" && (
            <button
              ...
              onClick={() => navigate("/setup-member/faq-subcategory")}
            >
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          <div className="bg-[#F6F4EE] px-6 py-4 border-b border-gray-200">
            <h3 className="text-lg font-bold text-gray-900">FAQ Sub Categories List</h3>
          </div>
          <div className="p-6">
            {loading ? (
              ...
              <>
                  ...
                  <Table className="border-separate">
                    <TableHeader>
                      <TableRow className="hover:bg-gray-50" style={{ backgroundColor: "#e6e2d8" }}>
                        ...
                        <TableHead className="font-semibold text-gray-900 py-3 px-4 border-r" style={{ borderColor: "#fff", width: "150px" }}>FAQ Category ID</TableHead>
                    ...
                    <TableBody>
                      {displayedSubCategories.length > 0 ? (
                        displayedSubCategories.map((subCategory, index) => (
                          <TableRow key={subCategory.id || index} className="hover:bg-gray-50 transition-colors">
                            <TableCell className="py-3 px-4">
                              {/* {faqSubCategoryPermissions.update === "true" && ( */}
                                <button
                                  onClick={() => navigate(`/setup-member/faq-subcategory/${subCategory.id}/edit`)}
                            ...
                            <TableCell className="py-3 px-4">{subCategory.faq_category_id || "-"}</TableCell>
                            <TableCell className="py-3 px-4">
                        ...
                        <TableRow>
                          <TableCell colSpan={5} className="text-center py-12 text-gray-500">
                            {searchQuery ? (
                              <div>
                                <p className="text-lg mb-2">No FAQ sub categories found</p>
                ...
                {/* Pagination */}
                {displayedSubCategories.length > 0 && totalPages > 1 && (
