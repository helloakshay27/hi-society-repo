...
export const TrainingConductedDashboard = () => {
    ...
    const renderCell = (item: AuditConductedOccurrence, columnKey: string) => {
        switch (columnKey) {
            case 'actions':
                return (
                    <Button variant="ghost" size="sm" onClick={() => console.log('View conducted training:', item.id)}>
    ...
    return (
        <div className="p-6">
            <div className="mb-6">
                <div>
                    <p className="text-[#1a1a1a] opacity-70 mb-2">Training &gt; Training Conducted List</p>
                    <h1 className="text-2xl font-bold text-[#1a1a1a]">TRAINING CONDUCTED LIST</h1>
                </div>
            </div>
                    ...
                    {totalPages > 1 && (
                        <div className="mt-6">
                            ...
                            <div className="text-center mt-2 text-sm text-gray-600">
                                Showing page {currentPage} of {totalPages} ({totalCount} total trainings)
                            </div>
                        </div>
                    )}
                </>
