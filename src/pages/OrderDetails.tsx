    ...
    <div className="p-6 bg-[#fafafa] min-h-screen">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-sm border">
            <div className="px-6 py-6">
              <h2 className="text-lg font-semibold text-[#C72030] mb-6">
                Order Items
              </h2>
                  ...
                  <div key={item.id} className="flex gap-4">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-xs text-gray-500">
                        ₹{parseFloat(item.price || 0).toFixed(0)} each
                      </p>
                    </div>
                  </div>
                ))}
              ...
              <div className="border-t pt-4 space-y-2">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="text-gray-900">
                    ₹{parseFloat(orderData?.subtotal || 0).toFixed(0)}
                  </span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-700">Tax</span>
                  <span className="text-gray-900">
                    ₹{parseFloat(orderData?.taxAmount || 0).toFixed(0)}
                  </span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-700">Shipping</span>
                  <span className="text-gray-900">
                    ₹{parseFloat(orderData?.shippingCost || 0).toFixed(0)}
                  </span>
                </div>
                ...
                <div className="space-y-0">
                  {timelineEvents.map((event, index) => {
                    ...
                    return (
                      <div
                        key={event.id || index}
                        className="relative flex items-start justify-between py-4"
                      >
        ...
        <div className="lg:col-span-1 space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-semibold text-[#C72030]">
                      {orderData?.customerLoyaltyPoints || "-"}
                    </p>
                  </div>
                </div>
          ...
          <div className="bg-[#FAF9F6] rounded-lg shadow-sm border border-[#F5F5F5]">
            <div className="px-6 py-6 border-b border-[#F5F5F5]">
              <div className="flex items-center gap-2">
                <Award className="w-5 h-5 text-[#B88C67]" />
            ...
            <div className="p-6 space-y-6">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-white p-3 rounded-md shadow-sm">
                  ...
                  <p className="text-2xl font-semibold text-red-600">
                    -{orderData?.loyaltyPointsRedeemed || 0}
                  </p>
                </div>
              </div>
              ...
              <div className="flex justify-between items-center py-3 border-t border-b border-gray-200">
                ...
                <span className="font-semibold text-[#C72030] text-lg">
                  {orderData?.loyaltyPointsEarned || 0} pts
                </span>
              </div>
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-baseline">
                  <div>
                    ...
                    <p className="font-semibold text-gray-900">
                      {orderData?.tierName || "Gold"}
                    </p>
                  </div>
                  <div className="text-right">
                    <p className="text-xs text-gray-500 mb-1">Next Tier</p>
                    <p className="font-semibold text-gray-900">
                      {orderData?.nextTierName || "Platinum"}
                    </p>
                  </div>
                </div>

                <div className="space-y-2">
                  <div className="w-full bg-gray-200 rounded-full h-1.5 flex justify-between">
                    <div
                      className="bg-[#EAB308] h-1.5 rounded-full"
                      style={{
                        width: `${orderData?.progress || 0}%`,
                      }}
                    ></div>
                    <div className="bg-gray-300 h-1.5 rounded-full flex-1"></div>
                  </div>
                  <p className="text-xs text-center text-gray-500">
                    {orderData?.pointsToNextTier || 0} points to reach{" "}
                    {orderData?.nextTierName || "Platinum"}
                  </p>
                </div>
              </div>

              {parseFloat(orderData?.loyaltyPointsEarned || "0") > 0 && (
                <div className="bg-[#E0F2F1] rounded-md p-3 flex items-center justify-center gap-2">
                  <span className="text-sm font-medium text-[#00695C]">
                    🎉 This order earned {orderData?.loyaltyPointsEarned}{" "}
                    loyalty points!
                  </span>
                </div>
              )}
