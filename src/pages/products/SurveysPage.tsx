...
const surveysData: ProductData = {
  name: "Surveys",
  description: "A configurable feedback platform for questionnaires, distribution, analytics, and sentiment tracking.",
  brief: "Collect and analyse structured feedback to drive data-led improvements — replacing untracked email surveys and WhatsApp polls with actionable sentiment data.",
  ...
  industries: "Real Estate Development, Residential, Commercial Real Estate, Manufacturing, BFSI, IT/ITES, Hospitality, Education, Hospitals, Retail Chain",
  ...
  owner: "Abdul and Dinesh", ownerImage: "",
  extendedContent: {
    featureSummary: (
    ...
    productSummaryNew: {
      identity: [
        { field: "Product Name", detail: "Surveys" },
        ...
        { field: "Product Owner", detail: "Abdul and Dinesh" },
      ],
      ...
      today: [
        ...
        { dimension: "Target Markets", state: "Real Estate Development, Residential, Commercial Real Estate, Manufacturing, BFSI, IT/ITES, Hospitality, Education, Hospitals, Retail Chain" },
      ],
    },
    detailedFeatures: [
...
const SurveysPage: React.FC = () => <BaseProductPage productData={surveysData} />;
