...
const officeAlternativeData: ProductData = {
  name: "Microsoft Office Alternative",
  description: "A data-sovereign productivity suite for docs, sheets, slides, and co-authoring.",
  brief: "Provide a full productivity suite for documents, collaboration, and team workflows — keeping all data on client-owned infrastructure instead of Microsoft or Google servers.",
  ...
  industries: "All Industries — Real Estate Development, Commercial Real Estate, Manufacturing, BFSI, IT/ITES, Hospitality, Education, Hospitals, Retail Chain, Facility Management",
  ...
  extendedContent: {
    ...
    productSummaryNew: {
      identity: [
        { field: "Product Name", detail: "Microsoft Office Alternative" },
      ...
      today: [
        ...
        { dimension: "Target Markets", state: "All Industries — Real Estate Development, Commercial Real Estate, Manufacturing, BFSI, IT/ITES, Hospitality, Education, Hospitals, Retail Chain, Facility Management" },
      ],
    },
    detailedFeatures: [
...
const OfficeAlternativePage: React.FC = () => <BaseProductPage productData={officeAlternativeData} />;
export default OfficeAlternativePage;