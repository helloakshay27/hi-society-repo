...
const leaseManagementData: ProductData = {
  name: "Lease Management",
  description: "A lease administration platform for rent, compliance, AMC, utilities, maintenance, and reporting.",
  brief: "Centralise lease management, financial tracking, and compliance across all leased properties — eliminating missed escalations, incorrect CAM charges, and Excel-based tracking.",
  ...
  industries: "Commercial Real Estate, Retail Chain, Malls, IT Park, SEZ, Industrial and Logistic Parks, Warehousing",
  ...
  owner: "Deepak Yadav and Deepak Gupta", ownerImage: "",
  extendedContent: {
    featureSummary: (
    ...
    productSummaryNew: {
      identity: [
        { field: "Product Name", detail: "Lease Management" },
        ...
        { field: "Product Owner", detail: "Deepak Yadav and Deepak Gupta" },
      ],
      ...
      today: [
        ...
        { dimension: "Target Markets", state: "Commercial Real Estate, Retail Chain, Malls, IT Park, SEZ, Industrial and Logistic Parks, Warehousing" },
      ],
    },
    detailedFeatures: [
...
const LeaseManagementPage: React.FC = () => <BaseProductPage productData={leaseManagementData} />;
