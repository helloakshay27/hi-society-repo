...
const accountingData: ProductData = {
  name: "Accounting",
  description: "A financial management platform for GL, AP/AR, invoicing, compliance, budgeting, and reporting.",
  brief: "Manage end-to-end financial operations with compliance and real-time reporting — eliminating disconnected invoicing, payroll, and ledger tools.",
  ...
  industries: "Real Estate Development, Residential, Commercial Real Estate, Clubs, Facility Management, Property Management, Manufacturing, BFSI, IT/ITES, Hospitality",
  ...
  owner: "Saba and Deepak Yadav", ownerImage: "",
  extendedContent: {
    featureSummary: (
    ...
    productSummaryNew: {
      identity: [
        { field: "Product Name", detail: "Accounting" },
        ...
        { field: "Product Owner", detail: "Saba and Deepak Yadav" },
      ],
      ...
      today: [
        ...
        { dimension: "Target Markets", state: "Real Estate Development, Residential, Commercial Real Estate, Clubs, Facility Management, Property Management, Manufacturing, BFSI, IT/ITES, Hospitality" },
      ],
    },
    detailedFeatures: [
...
const AccountingPage: React.FC = () => <BaseProductPage productData={accountingData} />;
