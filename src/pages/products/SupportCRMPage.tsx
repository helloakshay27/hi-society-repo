...
const supportCRMData: ProductData = {
  name: "Support CRM",
  description: "A ticketing platform for customer support, SLAs, escalations, and resolution tracking.",
  brief: "Manage customer support with structured ticketing, SLAs, and resolution tracking — eliminating missed SLAs and scattered query management.",
  ...
  industries: "Real Estate Development, Residential, Commercial Real Estate, Facility Management, Property Management, Hospitality, IT/ITES, BFSI, Education",
  ...
  extendedContent: {
    ...
    productSummaryNew: {
      identity: [
        { field: "Product Name", detail: "Support CRM" },
      ...
      today: [
        ...
        { dimension: "Target Markets", state: "Real Estate Development, Residential, Commercial Real Estate, Facility Management, Property Management, Hospitality, IT/ITES, BFSI, Education" },
      ],
    },
    detailedFeatures: [
...
const SupportCRMPage: React.FC = () => <BaseProductPage productData={supportCRMData} />;
export default SupportCRMPage;