...
const lmsSalesCRMData: ProductData = {
  name: "LMS and Sales CRM",
  description: "A lead-to-training platform for pipeline management, follow-ups, content, and performance tracking.",
  brief: "Enable sales teams with integrated training, content, and pipeline management tools — eliminating knowledge gaps that lead to lost sales.",
  ...
  industries: "Real Estate Development, Residential, Commercial Real Estate, Mixed-use Real Estate, Hospitality, Co-working, Clubs, Offices",
  ...
  owner: "Sagar and Sakshi", ownerImage: "",
  extendedContent: {
    featureSummary: (
    ...
    productSummaryNew: {
      identity: [
        { field: "Product Name", detail: "LMS and Sales CRM" },
        ...
        { field: "Product Owner", detail: "Sagar and Sakshi" },
      ],
      ...
      today: [
        ...
        { dimension: "Target Markets", state: "Real Estate Development, Residential, Commercial Real Estate, Mixed-use Real Estate, Hospitality, Co-working, Clubs, Offices" },
      ],
    },
    detailedFeatures: [
...
const LMSSalesCRMPage: React.FC = () => <BaseProductPage productData={lmsSalesCRMData} />;
export default LMSSalesCRMPage;