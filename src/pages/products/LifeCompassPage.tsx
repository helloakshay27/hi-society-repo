...
const lifeCompassData: ProductData = {
  name: "Life Compass",
  description: "A personal productivity app for goals, habits, tasks, journaling, and wellbeing.",
  brief: "Align daily habits, tasks, and goals to drive productivity and personal wellbeing — bridging the gap between intention and execution.",
  ...
  industries: "Professional Services, Education, Offices, Co-working, IT/ITES, Hospitals, BFSI",
  ...
  extendedContent: {
    ...
    productSummaryNew: {
      identity: [
        { field: "Product Name", detail: "Life Compass" },
      ...
      today: [
        ...
        { dimension: "Target Markets", state: "Professional Services, Education, Offices, Co-working, IT/ITES, Hospitals, BFSI" },
      ],
    },
    detailedFeatures: [
...
const LifeCompassPage: React.FC = () => <BaseProductPage productData={lifeCompassData} />;
