...
const businessCompassData: ProductData = {
  name: "Business Compass",
  description: "A strategy execution platform for OKRs, KPIs, reviews, and performance tracking.",
  brief: "Cascade and track business goals and KPIs with real-time performance visibility — eliminating strategy-to-execution gaps.",
  ...
  industries: "Commercial Real Estate, Offices, Real Estate Development, Manufacturing, BFSI, IT/ITES, Retail Chain, Hospitality, Education, Co-working",
  ...
  owner: "Gayatri and Deepak Yadav", ownerImage: "",
  extendedContent: {
    featureSummary: (
    ...
    productSummaryNew: {
      identity: [
        { field: "Product Name", detail: "Business Compass" },
        ...
        { field: "Product Owner", detail: "Gayatri and Deepak Yadav" },
      ],
      ...
      today: [
        ...
        { dimension: "Target Markets", state: "Commercial Real Estate, Offices, Real Estate Development, Manufacturing, BFSI, IT/ITES, Retail Chain, Hospitality, Education, Co-working" },
      ],
    },
    detailedFeatures: [
...
const BusinessCompassPage: React.FC = () => <BaseProductPage productData={businessCompassData} />;
export default BusinessCompassPage;