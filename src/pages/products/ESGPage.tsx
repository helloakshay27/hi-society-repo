...
const esgData: ProductData = {
  name: "ESG",
  description: "A sustainability reporting platform for data capture, KPI tracking, and disclosure compliance.",
  brief: "Digitise ESG tracking and reporting for regulatory and investor compliance — eliminating manually assembled spreadsheet reports from across teams.",
  ...
  industries: "Manufacturing, EPCE, Real Estate Development, Commercial Real Estate, Industrial and Logistic Parks, BFSI, IT/ITES, Pharma, Chemicals, Hospitals, SEZ, Data Centers",
  ...
  extendedContent: {
    ...
    productSummaryNew: {
      ...
      today: [
        ...
        { dimension: "Target Markets", state: "Manufacturing, EPCE, Real Estate Development, Commercial Real Estate, Industrial and Logistic Parks, BFSI, IT/ITES, Pharma, Chemicals, Hospitals, SEZ, Data Centers" },
      ],
    },
    detailedFeatures: [
...
const ESGPage: React.FC = () => <BaseProductPage productData={esgData} />;
