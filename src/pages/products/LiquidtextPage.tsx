...
const liquidtextData: ProductData = {
  name: "Liquidtext",
  description: "A multi-document analysis platform for annotation, cross-referencing, and insight synthesis.",
  brief: "Analyse and synthesise insights across multiple documents in a unified workspace — enabling faster research, contract review, and knowledge synthesis.",
  ...
  industries: "Professional Services, BFSI, Banking, Education, Real Estate Development, IT/ITES, Hospitals, Offices, Co-working",
  ...
  extendedContent: {
    ...
    productSummaryNew: {
      identity: [
        { field: "Product Name", detail: "Liquidtext" },
      ...
      today: [
        ...
        { dimension: "Target Markets", state: "Professional Services, BFSI, Banking, Education, Real Estate Development, IT/ITES, Hospitals, Offices, Co-working" },
      ],
    },
    detailedFeatures: [
...
const LiquidtextPage: React.FC = () => <BaseProductPage productData={liquidtextData} />;
