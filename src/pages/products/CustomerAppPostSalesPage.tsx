...
const customerAppPostSalesData: ProductData = {
  name: "Customer App Post Sales",
  description: "A referral and loyalty platform that turns buyers into brand advocates.",
  brief: "Convert satisfied homebuyers into referral-driven sales channels through loyalty engagement and structured referral rewards.",
  ...
  industries: "Real Estate Development, Residential, Commercial Real Estate, Mixed-use Real Estate, Hospitality",
  ...
  extendedContent: {
    ...
    productSummaryNew: {
      identity: [
        { field: "Product Name", detail: "Customer App Post Sales" },
      ...
      today: [
        ...
        { dimension: "Target Markets", state: "Real Estate Development, Residential, Commercial Real Estate, Mixed-use Real Estate, Hospitality" },
      ],
    },
    detailedFeatures: [
...
const CustomerAppPostSalesPage: React.FC = () => <BaseProductPage productData={customerAppPostSalesData} />;
export default CustomerAppPostSalesPage;