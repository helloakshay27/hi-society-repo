...
const momPhoneMicData: ProductData = {
  name: "MOM with Phone Mic",
  description: "An AI meeting notes tool that records, transcribes, and links action items to tasks.",
  brief: "Automate meeting transcription, action tracking, and task-linked follow-ups — ending the era of forgotten meeting action items.",
  ...
  industries: "Real Estate Development, EPCE, Manufacturing, IT/ITES, BFSI, Professional Services, Offices, Co-working, Education, Hospitals, Facility Management",
  ...
  extendedContent: {
    ...
    productSummaryNew: {
      identity: [
        { field: "Product Name", detail: "MOM with Phone Mic" },
        ...
        { field: "Product Owner", detail: "Sadanand" },
      ],
      ...
      today: [
        ...
        { dimension: "Target Markets", state: "Real Estate Development, EPCE, Manufacturing, IT/ITES, BFSI, Professional Services, Offices, Co-working, Education, Hospitals, Facility Management" },
      ],
    },
    detailedFeatures: [
...
const MOMPhoneMicPage: React.FC = () => <BaseProductPage productData={momPhoneMicData} />;
export default MOMPhoneMicPage;