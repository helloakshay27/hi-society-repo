...
const mailingData: ProductData = {
  name: "Mailing",
  description: "A communication platform for campaigns, notifications, OTPs, alerts, and delivery analytics.",
  brief: "Manage campaigns, notifications, and alerts with segmentation and analytics — replacing disconnected communication tools with one unified platform.",
  ...
  industries: "All Industries — Real Estate Development, Commercial Real Estate, Manufacturing, BFSI, IT/ITES, Hospitality, Retail Chain, Education, Hospitals, Facility Management",
  ...
  extendedContent: {
    ...
    productSummaryNew: {
      identity: [
        { field: "Product Name", detail: "Mailing" },
      ...
      today: [
        ...
        { dimension: "Target Markets", state: "All Industries — Real Estate Development, Commercial Real Estate, Manufacturing, BFSI, IT/ITES, Hospitality, Retail Chain, Education, Hospitals, Facility Management" },
      ],
    },
    detailedFeatures: [
...
const MailingPage: React.FC = () => <BaseProductPage productData={mailingData} />;
