...
const realEstateCRMData: ProductData = {
  name: "Real Estate CRM",
  description: "A real estate sales ERP for leads, quotations, bookings, payments, and compliance.",
  brief: "Manage the full real estate sales and buyer lifecycle from lead to possession — with RERA fields, unit inventory, and payment milestones built in.",
  ...
  industries: "Real Estate Development, Residential, Commercial Real Estate, Mixed-use Real Estate, Hospitality, Asset Management, Co-working, Offices",
  ...
  extendedContent: {
    ...
    productSummaryNew: {
      identity: [
        { field: "Product Name", detail: "Real Estate CRM" },
      ...
      today: [
        ...
        { dimension: "Target Markets", state: "Real Estate Development, Residential, Commercial Real Estate, Mixed-use Real Estate, Hospitality, Asset Management, Co-working, Offices" },
      ],
    },
    detailedFeatures: [
...
const RealEstateCRMPage: React.FC = () => <BaseProductPage productData={realEstateCRMData} />;
export default RealEstateCRMPage;