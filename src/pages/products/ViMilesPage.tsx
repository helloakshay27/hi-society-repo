...
const viMilesData: ProductData = {
  name: "Vi Miles",
  description: "A multi-partner loyalty platform for earning and redeeming miles across categories.",
  brief: "Enable a multi-partner rewards ecosystem for retention and cross-category engagement — giving customers a reason to stay loyal across all the services they use.",
  ...
  industries: "Hospitality, Telecom, BFSI, Clubs, Automobiles, Retail Chain, FMCG, E-Commerce, Food and Beverage, Education",
  ...
  extendedContent: {
    ...
    productSummaryNew: {
      identity: [
        { field: "Product Name", detail: "Vi Miles" },
        ...
        { field: "Product Owner", detail: "Vinayak" },
      ],
      ...
      today: [
        ...
        { dimension: "Target Markets", state: "Hospitality, Telecom, BFSI, Clubs, Automobiles, Retail Chain, FMCG, E-Commerce, Food and Beverage, Education" },
      ],
    },
    detailedFeatures: [
...
const ViMilesPage: React.FC = () => <BaseProductPage productData={viMilesData} />;
export default ViMilesPage;