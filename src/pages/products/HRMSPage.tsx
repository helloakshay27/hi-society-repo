...
const hrmsData: ProductData = {
  name: "HRMS",
  description: "A workforce management platform for attendance, payroll, leave, appraisals, and ESS.",
  brief: "Manage the complete employee lifecycle with integrated HR operations and analytics — replacing fragmented attendance devices, Excel payroll, and email leave approvals.",
  ...
  industries: "Manufacturing, Real Estate Development, Commercial Real Estate, IT/ITES, BFSI, Hospitality, Retail Chain, Education, Hospitals, Facility Management",
  ...
  extendedContent: {
    ...
    productSummaryNew: {
      identity: [
        { field: "Product Name", detail: "HRMS" },
      ...
      today: [
        ...
        { dimension: "Target Markets", state: "Manufacturing, Real Estate Development, Commercial Real Estate, IT/ITES, BFSI, Hospitality, Retail Chain, Education, Hospitals, Facility Management" },
      ],
    },
    detailedFeatures: [
...
const HRMSPage: React.FC = () => <BaseProductPage productData={hrmsData} />;
