    ...
    <div className="p-6 bg-gray-50 min-h-screen overflow-y-auto">
      ...
      <div className="mb-8">
        <div className="flex items-center space-x-2 text-sm text-gray-600 mb-2">
          ...
          <span>{">"}</span>
          <span className="text-gray-900 font-medium">Edit Notice</span>
        </div>
      </div>
          ...
          <div className="p-6" style={{ backgroundColor: "#AAB9C50D" }}>
            ...
            <div>
              <div className="flex justify-between items-center mb-4">
                ...
                <button
                  type="button"
                  onClick={() => document.getElementById('editNoticeAttachmentInput')?.click()}
                  className="text-sm text-[#C72030] hover:underline font-medium"
                >
                  + Upload
                </button>
