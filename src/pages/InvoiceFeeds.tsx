...
import { getInvoiceFeeds } from '@/store/slices/invoicesSlice';
...
export const InvoiceFeeds = () => {
    ...
    useEffect(() => {
        const fetchFeeds = async () => {
            try {
                const response = await dispatch(getInvoiceFeeds({ baseUrl, token, id: Number(id) })).unwrap();
