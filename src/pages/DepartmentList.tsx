      ...
      <div className="p-6 max-w-full h-[calc(100vh-50px)] overflow-y-auto">
        ...
        <div className="mb-6">
          <div className="flex items-center space-x-2 text-sm text-gray-600 mb-2">
            ...
            <ChevronRight className="w-4 h-4" />
            <span className="text-[#C72030] font-medium">Department</span>
          </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          <div className="bg-[#F6F4EE] px-6 py-4 border-b border-gray-200">
            <h3 className="text-lg font-bold text-gray-900">Department List</h3>
          </div>
          <div className="p-6">
            {loading ? (
              ...
              <>
                  ...
                  <Table className="border-separate">
                    <TableHeader>
                      <TableRow className="hover:bg-gray-50" style={{ backgroundColor: "#e6e2d8" }}>
                        ...
                        <TableHead className="font-semibold text-gray-900 py-3 px-4 border-r" style={{ borderColor: "#fff", minWidth: "180px" }}>Department Name</TableHead>
                        <TableHead className="font-semibold text-gray-900 py-3 px-4 border-r" style={{ borderColor: "#fff", minWidth: "150px" }}>Company Name</TableHead>
                        <TableHead className="font-semibold text-gray-900 py-3 px-4 border-r" style={{ borderColor: "#fff", minWidth: "180px" }}>Organization Name</TableHead>
                          ...
                          <TableRow key={department.id} className="hover:bg-gray-50 transition-colors">
                            <TableCell className="py-3 px-4">
                              {departmentPermission.update === "true" && (
                                <button
                                  onClick={() => navigate(`/setup-member/department-edit/${department.id}`)}
                            ...
                            <TableCell className="py-3 px-4">{department.name || "-"}</TableCell>
                            <TableCell className="py-3 px-4">{department.company_name || "-"}</TableCell>
                            <TableCell className="py-3 px-4">{department.organization_name || "-"}</TableCell>
                            <TableCell className="py-3 px-4">
                              <div className="flex justify-center">
                                <button
                                  onClick={() => handleToggleUser(department.id, department.active)}
                ...
                {/* Pagination */}
                {displayedDepartments.length > 0 && totalPages > 1 && (
