  ...
  const renderLeftActions = () => (
    <div className="flex items-center gap-3">
      ...
      <div className="relative">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger className="flex min-h-[40px] h-auto w-auto min-w-[140px] max-w-[300px] items-center justify-between rounded-md border border-gray-200 bg-white px-3 py-2 text-sm placeholder:text-muted-foreground focus:outline-none disabled:cursor-not-allowed disabled:opacity-50">
            <div className="flex flex-wrap gap-1">
              {selectedCategories.length === 0 ? (
                <span className="text-gray-500 font-normal">Select Group</span>
              ) : (
                selectedCategories.map((cat) => (
                  <div
                    key={cat}
                    className="flex items-center gap-1 bg-[#F0EBE0] px-2 py-0.5 rounded text-xs font-medium text-[#1A1A1A]"
                  >
                    {cat}
                    <X
        ...
        <div className="fixed bottom-1/2 left-1/2 -translate-x-1/2 z-50 bg-white rounded-lg shadow-[0_4px_24px_rgba(0,0,0,0.15)] flex items-center overflow-hidden min-w-[600px] min-h-[100px]">
            ...
            <div className="min-w-0">
              ...
              <p className="text-sm text-gray-500 truncate">
                ...
                {selectedProductIds.length > 1 &&
                  ` +${selectedProductIds.length - 1} more`}
              </p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-1 px-2">
            ...
            >
              ...
              >
                <path
                  d="M8.15309 3.15385C6.19156 1.19231 3.07617 0.576923 0.345403 1.42308C0.230018 1.42308 0.0761719 1.61538 0.0761719 1.92308C0.0761719 2.23077 0.0761719 3.07692 0.0761719 3.42308C0.0761719 3.73077 0.345403 3.80769 0.499249 3.76923C2.57617 2.92308 5.11463 3.30769 6.76848 5.03846L7.19156 5.46154C7.42233 5.69231 7.23002 6.11539 6.92233 6.11539H3.92233C3.61463 6.11539 3.3454 6.34615 3.3454 6.69231V7.84615C3.3454 8.15385 3.57617 8.42308 3.92233 8.42308L11.3069 8.5C11.6146 8.5 11.8839 8.26923 11.8839 7.92308L11.9223 0.576923C11.9223 0.269231 11.6916 0 11.3454 0H10.1916C9.88386 0 9.57617 0.230769 9.57617 0.538462L9.53771 3.57692C9.53771 3.88462 9.11463 4.07692 8.88386 3.84615C8.92233 3.88462 8.15309 3.15385 8.15309 3.15385Z"
                  fill="black"
                />
                <path
                  d="M0.576923 9.92311H1.73077C2.03846 9.92311 2.30769 10.1923 2.30769 10.5V15.577C2.30769 15.8847 2.57692 16.1539 2.88462 16.1539H15.5769C15.8846 16.1539 16.1538 15.8847 16.1538 15.577V5.73081C16.1538 5.42311 15.8846 5.15388 15.5769 5.15388H14.0385C13.7308 5.15388 13.4615 4.88465 13.4615 4.57696V3.42311C13.4615 3.11542 13.7308 2.84619 14.0385 2.84619H16.9231C17.7692 2.84619 18.4615 3.5385 18.4615 4.38465V16.9231C18.4615 17.7693 17.7692 18.4616 16.9231 18.4616H1.53846C0.692308 18.4616 0 17.7693 0 16.9231V10.5C0 10.1923 0.269231 9.92311 0.576923 9.92311Z"
                  fill="black"
                />
              </svg>
              <span className="text-sm mt-2 font-medium text-gray-900">
            ...
            <div className="flex justify-between items-start">
              <div>
                ...
                <DialogDescription className="text-sm text-gray-500 mt-1">
                  Add a new SKU to the catalog with pricing and points
                  configuration
                </DialogDescription>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  className="bg-gray-50 border-[#e5e1d8] pr-10"
