      ...
      <div className="p-6 max-w-full h-[calc(100vh-50px)] overflow-y-auto">
        ...
        <div className="mb-6">
          <div className="flex items-center space-x-2 text-sm text-gray-600 mb-2">
            ...
            <ChevronRight className="w-4 h-4" />
            <span className="text-[#C72030] font-medium">Site</span>
          </div>
          <h1 className="text-2xl font-bold text-gray-900">SITE</h1>
        </div>
        ...
        <div className="flex justify-end items-center gap-3 mb-4">
          ...
          {sitePermission.create === "true" && (
            <button
              ...
              onClick={() => navigate("/setup-member/site-create")}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width={20}
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          <div className="bg-[#F6F4EE] px-6 py-4 border-b border-gray-200">
            <h3 className="text-lg font-bold text-gray-900">Site List</h3>
          </div>
          <div className="p-6">
            {loading ? (
                          ...
                          >
                            <TableCell className="py-3 px-4">
                              {sitePermission.update === "true" && (
                                <button
                                  onClick={() =>
                                    navigate(`/setup-member/site-edit/${site.id}`)
                                  }
                            ...
                            <TableCell className="py-3 px-4">
                              {site.site_company_name || "-"}
                            </TableCell>
                            <TableCell className="py-3 px-4">
                              {site.site_department_name || "-"}
                            </TableCell>
                            <TableCell className="py-3 px-4">
                              {site.site_project_name || "-"}
                            </TableCell>
                          </TableRow>
                        ))
                      ) : (
                    ...
                    <div>
                      <p className="text-sm text-gray-600">
                        ...
                        <span className="font-medium">
                          {pagination.total_count === 0 ? 0 : startIndex + 1}
                        </span>{" "}
                        to{" "}
                        <span className="font-medium">
                          {Math.min(
