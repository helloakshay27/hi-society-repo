    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-lg p-6 w-[30rem]">
        ...
        <p className="text-sm text-gray-600 mb-4">
          This task is overdue. Please provide a reason for the overdue status.
        </p>
        <textarea
          value={reason}
              ...
              {milestoneTitle && (
                <>
                  <BreadcrumbItem>
                    <BreadcrumbLink
                      onClick={() =>
                        navigate(`/mobile-projects/${id}/milestones`)
                      }
                    >
                      {milestoneTitle}
                    </BreadcrumbLink>
                ...
                <div className="mb-4 pb-4 border-b border-gray-200">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleCompletionPercentageChange(
                          task.id,
                          e.target.value
                        )
                      }
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-4">
                    <Button
                      ...
                      onClick={() =>
                        navigate(
                          `/mobile-projects/${id}/milestones/${mid}/tasks/${task.id}`
                        )
                      }
                    >
