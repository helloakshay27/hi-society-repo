  ...
  const screenshots = [
    {
      ...
      description: 'Comprehensive lease management dashboard'
    },
    {
      id: 2,
      title: 'Contract Management',
      image: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=800&h=600&fit=crop&crop=center',
      description: 'Advanced contract management interface'
    },
    {
      id: 3,
      title: 'Property Portfolio',
      image: 'https://images.unsplash.com/photo-1560472354-b33ff0c44a43?w=800&h=600&fit=crop&crop=center',
      description: 'Property portfolio management view'
    },
    {
      id: 4,
      title: 'Financial Reports',
      image: 'https://images.unsplash.com/photo-1554224154-26032fbc4d66?w=800&h=600&fit=crop&crop=center',
  ...
  const reviews = [
    {
      ...
      rating: 5,
      date: 'March 20, 2024',
      title: 'Excellent lease management solution',
      comment: 'This platform has revolutionized how we handle our property portfolio. The contract management features are outstanding and the reporting is comprehensive.',
      helpful: 28,
      avatar: 'RC'
    },
    {
      ...
      comment: 'Very intuitive interface and powerful features. The integration capabilities have saved us countless hours of manual work.',
      helpful: 22,
      avatar: 'LM'
    },
    {
      ...
      title: 'Streamlined our operations',
      comment: 'The automated lease tracking and renewal notifications are game changers. Highly recommend for any property management company.',
      helpful: 35,
      avatar: 'JW'
    }
  ];
  ...
  const renderScreenshots = () => (
    <div className="space-y-6">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">Explore the key features and interface of Lease Management</p>
      </div>
            ...
            <div className="space-y-1">
              {[5, 4, 3, 2, 1].map((rating) => (
                <div key={rating} className="flex items-center space-x-2 text-sm">
                  ...
                  <span className="text-gray-500 w-8">{rating === 5 ? '5' : rating === 4 ? '2' : '0'}</span>
                </div>
              ))}
            </div>
          </div>
    ...
    <div className="space-y-6">
      <div className="bg-white p-6 rounded-lg shadow-sm border">
        <div className="flex items-start space-x-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-600 mb-4">
              FM Solutions is a leading provider of enterprise software solutions specializing in property management 
              and lease administration systems. With over 10 years of experience, we help real estate companies and 
              property managers streamline their operations through innovative technology solutions.
            </p>
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            { name: 'Property Analytics Pro', rating: 4.5, installs: '980+' },
            { name: 'Tenant Portal Manager', rating: 4.7, installs: '750+' },
            { name: 'Maintenance Scheduler', rating: 4.6, installs: '1.1K+' }
          ].map((app, index) => (
