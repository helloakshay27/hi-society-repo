...
const PlusServicesList = () => {
  ...
  const [plusServicesPermissions, setPlusServicesPermissions] = useState({});
  ...
  const getPlusServicesPermissions = () => {
    try {
      const lockRolePermissions = localStorage.getItem("lock_role_permissions");
      if (!lockRolePermissions) return {};

      const permissions = JSON.parse(lockRolePermissions);
      return permissions.plus_services || {};
    } catch (e) {
  ...
  useEffect(() => {
    const permissions = getPlusServicesPermissions();
    setPlusServicesPermissions(permissions);
  }, []);
  ...
  const fetchPlusServices = async () => {
    ...
    try {
      ...
      const servicesList = response.data.plus_services || response.data || [];
      ...
      <div className="p-6 max-w-full h-[calc(100vh-50px)] overflow-y-auto">
        ...
        <div className="mb-6">
          <div className="flex items-center space-x-2 text-sm text-gray-600 mb-2">
            ...
            <ChevronRight className="w-4 h-4" />
            <span className="text-[#C72030] font-medium">Plus Services</span>
          </div>
                          ...
                          >
                            <TableCell className="py-3 px-4">
                              <div className="flex items-center gap-2">
                                {plusServicesPermissions.update === "true" && (
                                  <button
                                    onClick={() =>
                                      navigate(
                            ...
                            <TableCell className="py-3 px-4">
                              <div className="flex justify-center items-center">
                                {service.attachment?.document_url ? (
                                  service.attachment.document_content_type?.startsWith(
                                    "video/"
                                  ) ? (
                                    <video
                                      width="80"
                                    ...
                                    >
                                      <source
                                        src={service.attachment.document_url}
                                        type={
                                    ...
                                    <a
                                      href={service.attachment.document_url}
                                      target="_blank"
                  ...
                  <div className="flex items-center justify-between mt-6 px-3">
                    ...
                    >
                      ...
                      >
                        <path
                          fillRule="evenodd"
                          d="M11.3 12.3a.8.8 0 0 1 0-1.1L13.2 9H1.5a.5.5 0 0 1 0-1h11.7L11.3 4.8a.8.8 0 1 1 1.1-1.1l3.2 3.2a.8.8 0 0 1 0 1.1l-3.2 3.2a.8.8 0 0 1-1.1 0z"
                        />
                      </svg>
                      First
                    </button>
                    ...
                    >
                      ...
                      >
                        <path
                          fillRule="evenodd"
                          d="M4.7 3.3a.8.8 0 0 1 1.1 0L7.5 5.2h11.7a.5.5 0 0 1 0 1H7.5l-2.7 1.9a.8.8 0 1 1-1.1-1.1l3.2-3.2a.8.8 0 0 1 1.1 0l3.2 3.2a.8.8 0 0 1 0 1.1l-3.2 3.2a.8.8 0 0 1-1.1 0z"
                        />
                      </svg>
                      Next
                    </button>
