      ...
      <div className="p-6 max-w-full h-[calc(100vh-50px)] overflow-y-auto">
        ...
        <div className="flex justify-end items-center gap-3 mb-4">
          ...
          {organizationPermission.create === "true" && (
            <button
              ...
              onClick={() => navigate("/setup-member/organization-create")}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width={20}
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          <div className="bg-[#F6F4EE] px-6 py-4 border-b border-gray-200">
            <h3 className="text-lg font-bold text-gray-900">Organization List</h3>
          </div>
          <div className="p-6">
            {loading ? (
              ...
              <>
                ...
                {/* Pagination */}
                {displayedOrganizations.length > 0 && totalPages > 1 && (
                  <div className="flex items-center justify-between mt-6 px-3">
                    ...
                    <div>
                      <p className="text-sm text-gray-600">
                        ...
                        to{" "}
                        <span className="font-medium">
                          {Math.min(startIndex + displayedOrganizations.length, totalFiltered)}
                        </span>{" "}
                        of{" "}
