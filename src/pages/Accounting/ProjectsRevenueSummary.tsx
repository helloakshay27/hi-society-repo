...
interface ProjectsRevenueSummaryRow {
  id: string;
...
const MOCK_ROWS: ProjectsRevenueSummaryRow[] = [];
...
const ProjectsRevenueSummary: React.FC = () => {
  ...
  const renderRow = (row: ProjectsRevenueSummaryRow) => ({
    project: (
      ...
      <div className="overflow-hidden rounded-lg border border-[#EAECF0] bg-white">
        ...
        <div className="p-4">
          <EnhancedTaskTable
            ...
            columns={columns}
            renderRow={renderRow}
            storageKey="projects-revenue-summary-v1"
            hideTableExport
            hideTableSearch
            hideColumnsButton
...
export default ProjectsRevenueSummary;
