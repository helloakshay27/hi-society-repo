...
const MOCK_ROWS: ProjectDetailsRow[] = [];
...
const ProjectDetails: React.FC = () => {
  ...
  const renderRow = (row: ProjectDetailsRow) => ({
    taskName: (
    ...
    billedHours: numCell(row.billedHours),
    billedAmount: numCell(row.billedAmount),
    unbilledAmount: numCell(row.unbilledAmount),
  });
