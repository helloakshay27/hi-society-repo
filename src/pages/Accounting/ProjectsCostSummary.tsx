...
interface ProjectsCostSummaryRow {
  id: string;
  ...
  description: string;
  customerName: string;
  costFromTransactions: string;
  costFromTimesheet: string;
  budgetAmount: string;
}
...
const columns: ColumnConfig[] = [
  ...
  {
    key: "costFromTransactions",
    label: "COST FROM TRANSACTIONS",
    sortable: true,
    hideable: false,
    draggable: true,
  },
  {
    key: "costFromTimesheet",
    label: "COST FROM TIMESHEET",
    sortable: true,
    hideable: false,
    draggable: true,
  },
...
const MOCK_ROWS: ProjectsCostSummaryRow[] = [];
...
const ProjectsCostSummary: React.FC = () => {
  ...
  const renderRow = (row: ProjectsCostSummaryRow) => ({
    project: (
    ...
    costFromTransactions: numCell(row.costFromTransactions),
    costFromTimesheet: numCell(row.costFromTimesheet),
    budgetAmount: numCell(row.budgetAmount),
  });
      ...
      <div className="overflow-hidden rounded-lg border border-[#EAECF0] bg-white">
        ...
        <div className="p-4">
          <EnhancedTaskTable
            ...
            columns={columns}
            renderRow={renderRow}
            storageKey="projects-cost-summary-v1"
            hideTableExport
            hideTableSearch
            hideColumnsButton
...
export default ProjectsCostSummary;
