...
const MOCK_ROWS: ProjectSummaryRow[] = [];
...
const ProjectSummary: React.FC = () => {
  ...
  const renderRow = (row: ProjectSummaryRow) => ({
    project: (
    ...
    loggedHours: numCell(row.loggedHours),
    budgetedHours: numCell(row.budgetedHours),
    loggedAmount: numCell(row.loggedAmount),
    budgetAmount: numCell(row.budgetAmount),
    billableHours: numCell(row.billableHours),
    nonBillableHours: numCell(row.nonBillableHours),
    billableAmount: numCell(row.billableAmount),
    nonBillableAmount: numCell(row.nonBillableAmount),
  });
