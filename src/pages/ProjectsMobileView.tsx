...
const ProjectsMobileView = () => {
  ...
  if (!token) {
    token =
      localStorage.getItem("token") || sessionStorage.getItem("mobile_token");
  }
  ...
  useEffect(() => {
    ...
    if (userId) {
      ...
      console.log(
        "✅ user_id stored in sessionStorage and localStorage:",
        userId
      );
    }
  }, [token, orgId, userId]);

  // Get baseUrl from auth utilities
  ...
  const fetchProjects = useCallback(
    ...
    [baseUrl, storedToken, token]
  ); // Added token to deps as it is used in URL
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <span
                        className={`${statusColor.bg} ${statusColor.text} pl-2 pr-3 py-1 rounded-full font-medium text-xs flex items-center gap-1.5`}
                      >
                        <span
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <Button
                          ...
                          onClick={() =>
                            navigate(
                              `/mobile-projects/${project.id}/milestones`
                            )
                          }
                        >
