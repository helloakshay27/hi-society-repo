...
/** K Raheja Corp Homes — Adoption & Engagement tab, matching the wireframe's pgAdopt section, wired to live Runwal-family PostHog APIs. */
  ...
  return (
    <section className="page on" id="pgAdopt">
      <div className="section-head">
        ...
        <span className="sd">
          Measure how effectively residents and prospects adopt and engage with the app&rsquo;s major modules, and whether they keep coming back
          day over day.
        </span>
      </div>
      ...
      <QuestionBox
        questions={[
          'Which modules and services receive the highest engagement and adoption?',
          'Which modules need UX improvements, and where do users spend the most time?',
          'Are users returning to the application, and is retention improving over time?',
          'How does usage differ between Pre-Sales prospects and Post-Sales homeowners, and across sites?',
        ]}
      />
      ...
      <div className="tiles" style={{ gridTemplateColumns: 'repeat(3, 1fr)', marginTop: '16px' }}>
        ...
        */}
        ...
        <KpiTile
          ...
          sub="of new registration/enquiry starts"
      ...
      <Card
        ...
        purpose="Weekly active residents/prospects over the last 8 weeks — the trend line behind the Adoption Trend tile above."
        ...
        {isTrendError ? (
          ...
          <>
            <LineChart
              ...
              curLabel="Weekly active users"
              prevLabel="Prior 8W"
            />
            <div className="legend">
              <span>
                <i style={{ background: 'var(--chart-blue)' }}></i> Weekly active users
              </span>
            </div>
          </>
        )}
      ...
      <div className="grid2">
        <Card
          id="card-roleSplit"
          infoKey="chart.roles"
          eyebrow="Adoption by audience"
          title="Who is (and isn't) using the app"
          purpose="Active users ÷ registered users, split by the role property stamped on every event — shows whether adoption skews toward Post-Sales homeowners or Pre-Sales prospects."
        >
          {isRolesError ? (
        ...
        <Card id="card-dormant" infoKey="chart.dormant" eyebrow="Dormant users" title="Dormant users" purpose="Users with no activity in the dormancy window from PostHog.">
          {isAdoptError ? (
