...
export const TopBar: React.FC<TopBarProps> = ({
  ...
  return (
    <header className="topbar">
      ...
      <button className="back" onClick={onBack || (() => window.history.back())} aria-label="Back" title="Go back">
        ←
      </button>

      <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
        <span className="topbar-title">{orgName} Analytics</span>
      ...
      <div style={{ position: 'relative' }} ref={profileRef}>
        ...
        >
          ...
          <div style={{ textAlign: 'left', display: 'flex', flexDirection: 'column', lineHeight: 1.15 }}>
            ...
            <span style={{ fontSize: '10px', color: 'var(--muted, #6f6e68)', fontWeight: 400 }}>{userRole}</span>
          </div>
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '10px' }}>
              ...
              <div style={{ overflow: 'hidden' }}>
                ...
                <div style={{ fontSize: '11px', color: 'var(--muted, #6f6e68)' }}>{userRole}</div>
              </div>
            </div>
